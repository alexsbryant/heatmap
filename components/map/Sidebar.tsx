...
export function Sidebar({ isCollapsed, onToggle }: SidebarProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className={`p-5 border-b border-stone-100 flex items-center ${
      ...
      >
        {!isCollapsed && (
          <Link
            href="/"
            className="font-display text-xl font-bold text-stone-900 hover:text-accent-600 transition-colors"
          >
            Prism
          </Link>
        )}
